      ...
      <Card className="w-full max-w-md bg-white/10 dark:bg-white/5 text-inherit shadow-lg border border-white/10 backdrop-blur">
        ...
        <form onSubmit={handleSubmit(handleLogin)}>
          ...
          <CardFooter className="flex flex-col items-stretch gap-4">
            <Button
              type="submit"
              className="bg-gradient-to-r from-[#3b82f6] via-[#2563eb] to-[#1d4ed8] text-white hover:brightness-110 dark:bg-blue-600 dark:hover:bg-blue-700 dark:bg-none transition-colors duration-200"
              disabled={loading}
            >
              {loading
